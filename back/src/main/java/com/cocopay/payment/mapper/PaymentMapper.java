...
public interface PaymentMapper {
    ...
    CardOfferResponseDto toResponseDto(PerformanceKey key, UserCard userCard);

    @Mapping(source = "userCard", target = "cardUuid")
    @Mapping(source = "key.level",target = "level")
    @Mapping(source = "key.nextLevel",target = "nextLevel")
    @Mapping(source = "key.price",target = "price")
    @Mapping(source = "key.totalPrice",target = "totalPrice")
    CardOfferResponseDto toResponseDtoTest(PerformanceKey key, int userCard);
