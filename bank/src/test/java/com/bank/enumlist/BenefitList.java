...
public enum BenefitList {
    ...
    실적4("카카오뱅크 프렌즈 체크카드", "카페/디저트/디저트", "스타벅스", 10, DiscountType.페이백, 1000000),
    ...
    실적13("노리2 체크카드(KB Pay)", "카페/디저트/디저트", "스타벅스", 10, DiscountType.현장할인, 3000),
    실적14("노리2 체크카드(KB Pay)", "카페/디저트/디저트", "커피빈", 10, DiscountType.현장할인, 3000),
    실적15("노리2 체크카드(KB Pay)", "카페/디저트/디저트", "뚜레주르", 10, DiscountType.현장할인, 3000),
    실적16("노리2 체크카드(KB Pay)", "카페/디저트/디저트", "투썸플레이스", 10, DiscountType.현장할인, 3000),
    실적17("노리2 체크카드(KB Pay)", "카페/디저트", "카페/디저트베네", 10, DiscountType.현장할인, 3000),
    ...
    실적64("삼성 iD ON 카드", "카페/디저트/디저트", "스타벅스", 30, DiscountType.현장할인, 10000),
    실적65("삼성 iD ON 카드", "카페/디저트/디저트", "이디야커피", 30, DiscountType.현장할인, 10000),
    실적66("삼성 iD ON 카드", "카페/디저트/디저트", "투썸플레이스", 30, DiscountType.현장할인, 10000),
    실적67("삼성 iD ON 카드", "카페/디저트/디저트", "탐앤탐스", 30, DiscountType.현장할인, 10000),
    실적68("삼성 iD ON 카드", "카페/디저트/디저트", "카페/디저트베네", 30, DiscountType.현장할인, 10000),
    실적69("삼성 iD ON 카드", "카페/디저트/디저트", "드롭탑", 30, DiscountType.현장할인, 10000),
    실적70("삼성 iD ON 카드", "배달", "배달의민족", 30, DiscountType.현장할인, 10000),
    실적71("삼성 iD ON 카드", "배달", "요기요", 30, DiscountType.현장할인, 10000),
    실적72("삼성 iD ON 카드", "카페/디저트/디저트", "버스", 10, DiscountType.청구할인, 10000),
    실적73("삼성 iD ON 카드", "카페/디저트/디저트", "지하철", 10, DiscountType.청구할인, 10000),
    실적74("삼성 iD ON 카드", "카페/디저트/디저트", "택시", 10, DiscountType.청구할인, 10000),
    ...
    실적81("현대카드ZERO Edition2(할인형)", "카페/디저트/디저트", "스타벅스", 2, DiscountType.청구할인, 1000000),
    실적82("현대카드ZERO Edition2(할인형)", "카페/디저트/디저트", "투썸플레이스", 2, DiscountType.청구할인, 1000000),
    실적83("현대카드ZERO Edition2(할인형)", "카페/디저트/디저트", "이디야커피", 2, DiscountType.청구할인, 1000000),
    ...
    실적116("KB국민 My WE:SH 카드", "카페/디저트/디저트", "스타벅스", 5, DiscountType.청구할인, 5000),
    실적117("KB국민 My WE:SH 카드", "카페/디저트/디저트", "커피빈", 5, DiscountType.청구할인, 5000),
    실적118("KB국민 My WE:SH 카드", "카페/디저트/디저트", "투썸플레이스", 5, DiscountType.청구할인, 5000),
    실적119("KB국민 My WE:SH 카드", "카페/디저트/디저트", "카페/디저트베네", 5, DiscountType.청구할인, 5000),
    실적121("KB국민 My WE:SH 카드", "카페/디저트/디저트", "탐앤탐스", 5, DiscountType.청구할인, 5000),
    ...
    실적130("DA@카드의정석", "카페/디저트/디저트", "스타벅스", 2, DiscountType.청구할인, 1000000),
    실적131("DA@카드의정석", "카페/디저트/디저트", "커피빈", 2, DiscountType.청구할인, 1000000),
    실적132("DA@카드의정석", "카페/디저트/디저트", "탐앤탐스", 2, DiscountType.청구할인, 1000000),
    실적133("DA@카드의정석", "카페/디저트/디저트", "뚜레쥬르", 2, DiscountType.청구할인, 1000000),
    실적134("DA@카드의정석", "카페/디저트/디저트", "파리바게뜨", 2, DiscountType.청구할인, 1000000),
    실적135("DA@카드의정석", "카페/디저트/디저트", "베스킨라빈스", 2, DiscountType.청구할인, 1000000),
    실적136("DA@카드의정석", "카페/디저트/디저트", "투썸플레이스", 2, DiscountType.청구할인, 1000000),
