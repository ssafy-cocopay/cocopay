...
public enum BenefitList {
    ...
    실적4("카카오뱅크 프렌즈 체크카드", "카페", "스타벅스", 10, DiscountType.페이백, 1000000),
    ...
    실적48("신한카드 Mr.Life", "대형쇼핑몰", "신세계백화점", 10, DiscountType.청구할인, 10000),
    실적49("신한카드 Mr.Life", "대형쇼핑몰", "이마트", 10, DiscountType.청구할인, 10000),
    실적50("신한카드 Mr.Life", "대형쇼핑몰", "홈플러스", 10, DiscountType.청구할인, 10000),
    실적51("신한카드 Mr.Life", "대형쇼핑몰", "현대백화점", 10, DiscountType.청구할인, 10000),
    실적52("신한카드 Mr.Life", "대형쇼핑몰", "롯데백화점", 10, DiscountType.청구할인, 10000),
    실적53("신한카드 Mr.Life", "대형쇼핑몰", "롯데마트", 10, DiscountType.청구할인, 10000),
    ...
    실적64("삼성 iD ON 카드", "카페", "스타벅스", 30, DiscountType.현장할인, 10000),
    실적65("삼성 iD ON 카드", "카페", "이디야커피", 30, DiscountType.현장할인, 10000),
    실적66("삼성 iD ON 카드", "카페", "투썸플레이스", 30, DiscountType.현장할인, 10000),
    실적67("삼성 iD ON 카드", "카페", "탐앤탐스", 30, DiscountType.현장할인, 10000),
    실적68("삼성 iD ON 카드", "카페", "카페베네", 30, DiscountType.현장할인, 10000),
    실적69("삼성 iD ON 카드", "카페", "드롭탑", 30, DiscountType.현장할인, 10000),
    실적70("삼성 iD ON 카드", "배달", "배달의민족", 30, DiscountType.현장할인, 10000),
    실적71("삼성 iD ON 카드", "배달", "요기요", 30, DiscountType.현장할인, 10000),
    실적72("삼성 iD ON 카드", "카페", "버스", 10, DiscountType.청구할인, 10000),
    실적73("삼성 iD ON 카드", "카페", "지하철", 10, DiscountType.청구할인, 10000),
    실적74("삼성 iD ON 카드", "카페", "택시", 10, DiscountType.청구할인, 10000),
    실적75("현대카드ZERO Edition2(할인형)", "대형쇼핑몰", "이마트", 2, DiscountType.청구할인, 1000000),
    실적76("현대카드ZERO Edition2(할인형)", "대형쇼핑몰", "홈플러스", 2, DiscountType.청구할인, 1000000),
    실적77("현대카드ZERO Edition2(할인형)", "대형쇼핑몰", "롯데마트", 2, DiscountType.청구할인, 1000000),
    ...
    실적81("현대카드ZERO Edition2(할인형)", "카페", "스타벅스", 2, DiscountType.청구할인, 1000000),
    실적82("현대카드ZERO Edition2(할인형)", "카페", "투썸플레이스", 2, DiscountType.청구할인, 1000000),
    실적83("현대카드ZERO Edition2(할인형)", "카페", "이디야커피", 2, DiscountType.청구할인, 1000000),
    ...
    실적90("현대카드Z family", "대형쇼핑몰", "이마트", 10, DiscountType.청구할인, 5000),
    실적91("현대카드Z family", "대형쇼핑몰", "홈플러스", 10, DiscountType.청구할인, 5000),
    실적92("현대카드Z family", "대형쇼핑몰", "롯데마트", 10, DiscountType.청구할인, 5000),
    ...
    실적116("KB국민 My WE:SH 카드", "카페", "스타벅스", 5, DiscountType.청구할인, 5000),
    실적117("KB국민 My WE:SH 카드", "카페", "커피빈", 5, DiscountType.청구할인, 5000),
    실적118("KB국민 My WE:SH 카드", "카페", "투썸플레이스", 5, DiscountType.청구할인, 5000),
    실적119("KB국민 My WE:SH 카드", "카페", "카페베네", 5, DiscountType.청구할인, 5000),
    실적121("KB국민 My WE:SH 카드", "카페", "탐앤탐스", 5, DiscountType.청구할인, 5000),
    실적122("KB국민 My WE:SH 카드", "영화", "CGV", 30, DiscountType.현장할인, 5000),
    실적123("KB국민 My WE:SH 카드", "영화", "롯데시네마", 30, DiscountType.현장할인, 5000),
    실적124("KB국민 My WE:SH 카드", "영화", "메가박스", 30, DiscountType.현장할인, 5000),
    ...
    실적130("DA@카드의정석", "카페", "스타벅스", 2, DiscountType.청구할인, 1000000),
    실적131("DA@카드의정석", "카페", "커피빈", 2, DiscountType.청구할인, 1000000),
    실적132("DA@카드의정석", "카페", "탐앤탐스", 2, DiscountType.청구할인, 1000000),
    실적133("DA@카드의정석", "카페", "뚜레쥬르", 2, DiscountType.청구할인, 1000000),
    실적134("DA@카드의정석", "카페", "파리바게뜨", 2, DiscountType.청구할인, 1000000),
    실적135("DA@카드의정석", "카페", "베스킨라빈스", 2, DiscountType.청구할인, 1000000),
    실적136("DA@카드의정석", "카페", "투썸플레이스", 2, DiscountType.청구할인, 1000000),
    ...
    실적140("DA@카드의정석", "대형쇼핑몰", "롯데백화점", 2, DiscountType.청구할인, 1000000),
    실적141("DA@카드의정석", "대형쇼핑몰", "신세계백화점", 2, DiscountType.청구할인, 1000000),
    실적142("DA@카드의정석", "대형쇼핑몰", "이마트", 2, DiscountType.청구할인, 1000000),
    실적143("DA@카드의정석", "대형쇼핑몰", "홈플러스", 2, DiscountType.청구할인, 1000000),
